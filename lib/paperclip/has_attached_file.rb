module Paperclip
  class HasAttachedFile
    ...
    def define_mongoid_fields
      if defined?(::Mongoid) && @klass.included_modules.include?(::Mongoid::Document)
        ...
        @klass.send(:field, :"#{@name}_updated_at", :type => Time)
      end
    end
